...
const PaymentPage: FC = () => {
  ...
  const multi_language = merchant.use_multi_language_payment_page
    ...
    <table className="subtab__content">
      <tbody>
        ...
        <tr className="content__table">
          ...
          <td>
            <ul className="table-list">{buildList(merchant.locales)}</ul>
          </td>
        </tr>
        <tr className="content__table-colored">
        ...
        <tr className="content__table">
          <td className="table-key">
            <span className="content__table-span">
              Логин финальной страницы
            </span>
          </td>
          <td>
            <span className="content__table-span">
              {merchant.finish_page_login}
            </span>
          </td>
        </tr>
        <tr className="content__table-colored">
          ...
          <td>
            <span className={`content__table-span ${multi_language}`} />
          </td>
        </tr>
        <tr className="content__table">
          <td className="table-key">
            <span className="content__table-span">
              Отображение информации о правилах МПС
            </span>
          </td>
          <td>
            <span
        ...
        <tr className="content__table-colored">
          <td className="table-key">
            <span className="content__table-span">
              Перенаправлять на заданную платёжную страницу
            </span>
          </td>
          <td>
            <span
        ...
        <tr className="content__table">
          <td className="table-key">
            <span className="content__table-span">
              Использует страницу ожидания завершения 3DS
            </span>
          </td>
          <td>
            <span
              className={`content__table-span ${includeOption(
                merchant.options,
                "USE_COMPLETION_FINISH_3DS_PAGE"
              )}`}
            />
          </td>
        </tr>
