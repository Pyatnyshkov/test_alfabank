    ...
    return <table className="subtab__content">
            <tbody>
                ...
                <tr className="content__table">
                    ...
                    <td>
                        <span className="content__table-span">{merchant.agreement_url}</span>
                    </td>
                </tr>
                <tr className="content__table-colored">
                    <td>
                    ...
                    <td>
                        <span className="content__table-span">{merchant.merchant_emails}</span>
                    </td>
                </tr>
                <tr className="content__table">
                    <td>
                    ...
                    <td>
                        <span className="content__table-span">{merchant.merchant_actual_address}</span>
                    </td>
                </tr>
                <tr className="content__table-colored">
                    <td>
                    ...
                    <td>
                        <span className="content__table-span">{merchant.merchant_phone}</span>
                    </td>
                </tr>
                <tr className="content__table">
                    <td>
                    ...
                    <td>
                        <span className="content__table-span">{merchant.merchant_feedback_email}</span>
                    </td>
                </tr>
                <tr className="content__table-colored">
                    <td>
